...
Em quase todo o sistema você vai se deparar com lista de dados, segue uma explição sobre como usá-las:

![UI](./assets/ui-list.jpg)

1) Coluna da lista, se ao passar o mouse e ela for clicável, você poderá ordenar de forma crescente ou decrescente;
