...
### Pesquisa por campos dinâmicos

Como é possível [criar campos dinâmicos](#) para o cadastro de bens, também é possível filtrar os bens na pesquisa por estes campos criados, basta utilizar a opção "Mais" nos filtros. Veja um exemplo:

![Filtros pelos campos dinâmicos](./assets/bem-filtros-mais.png)
...
<img src={require('./assets/lista-exportar.jpg').default} alt="Botões de Diário de entrada e saída" width="400" />
...
Os diários respeitam os critérios de pesquisa na lista de bens, ou seja, todos os filtros e ordenação aplicados também serão aplicados ao gerar o diário.

### Exportar para Excel

Assim como os diários demonstrados acima, o relatório em excel respeita os filtros aplicados na listagem de bens. Ao clicar em *Excel*, o resultado filtrado é exportado para uma planilha em excel. Você pode [customizar](../configuracoes/index.md) o que é exportado neste excel.
...
**Cidade da Placa:** Cidade da Placa do veículo. *Cuidado para não confundir com o outro campo Cidade mais abaixo, que se trata de onde o veículo está*<br />
...
**Processo:** Número do processo. Este campo não pode ser editado nesta tela, somente na aba Processo.<br />
...
**Título Principal:** É o título do anúncio. Precisa ter no máximo 200 caracteres.<br />
**Subtítulo:** O subtítulo é importante para complementar o anúncio do bem dentro dos marketplaces. Use-o para complementar informações que não foram possíveis inserir no título.<br />
**Sites:** Para quais sites integrados ao ERP este bem estará disponível. Esta função somente será possível em sites adaptados para venda direta do estoque, sem leilão.<br />
**Venda Direta:** .<br />
**Bem em Destaque:** .<br />
**Posição:** .<br />
