...
4. Preencha a **Descrição da página** (obrigatório) — ex.: "Conheça um pouco sobre nossa empresa".
5. Informe a **URL (slug)** — o trecho do endereço, ex.: `sobre-nos`.
...
- **Campos obrigatórios** para salvar: Nome (código curto), Título (mínimo 3 caracteres) e Conteúdo do template. O botão **Cadastrar/Atualizar** só fica habilitado quando todos estão preenchidos.
- O **Nome (código curto)** é o identificador da página — escolha algo simples e sem espaços.
- O editor de conteúdo permite **enviar imagens** que ficam embutidas na página.
