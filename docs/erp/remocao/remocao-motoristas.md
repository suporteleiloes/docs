...
Na linha do motorista, clique no ícone de desativar e confirme.

## Dicas e observações
- O nome é obrigatório e o CPF precisa ser válido; o botão de salvar fica bloqueado até as duas condições serem atendidas.
- O motorista é um **papel sobre a Pessoa** — o mesmo cadastro de pessoa pode ter outros papéis no sistema.
