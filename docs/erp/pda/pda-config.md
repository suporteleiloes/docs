...
![Configurar inventário](/img/manual/erp/pda-config.png)
...
4. O sistema gera o código da sessão automaticamente e abre o [coletor de inventário](./pda.md) já no contexto que você escolheu.
...
- [PDA — Coletor de inventário](./pda.md)
