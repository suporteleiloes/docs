        ...
        <main className={mainLayoutStyle.docMainContainer}>
          <div className="container padding-top--md padding-bottom--lg">
            ...
            <div className="content" style={{ maxWidth: "800px", textAlign: "justify" }}>
              ...
              <h2>1. Introdução</h2>
              <p>
                Estes Termos de Serviço (<strong>“Termos”</strong>) regem o uso do software ERP
                ...
                com alguma parte destes Termos, <strong>não utilize os serviços da Suporte Leilões</strong>.
              </p>

              <h3>1.1 Atualizações e Comunicações</h3>
              <p>
                A Suporte Leilões poderá, periodicamente, revisar estes Termos ou
                ...
                indicando a data da última atualização.{" "}
                <strong>
                  ℹ️ Recomendamos verificar regularmente o site oficial da Suporte Leilões
                  para manter-se informado sobre eventuais alterações destes Termos.
                </strong>{" "}
                Ao continuar a utilizar os serviços após a entrada em vigor de revisões, você reconhece e concorda em vincular-se aos
                Termos revisados. Você também reconhece que a Suporte Leilões não poderá ser responsabilizada caso você
                não tome conhecimento de atualizações destes Termos.
              </p>

              <h3>1.2 Comunicação Eletrônica</h3>
              <p>
                Você concorda em receber todas as comunicações, contratos, avisos e notificações (“Comunicações”) relativos aos
                ...
                recebimento adequado dessas Comunicações.
              </p>

              <h2>2. Definições</h2>
              <ul>
                <li>
                  <strong>Suporte Leilões:</strong> a empresa fornecedora do software ERP em modelo SaaS (Software
                  como Serviço) para leiloeiros públicos.
                </li>
                <li>
                  <strong>Leiloeiro:</strong> o cliente da Suporte Leilões, sendo um leiloeiro público oficial
                  devidamente registrado na junta comercial ou órgão competente de sua jurisdição.
                </li>
                <li>
                  <strong>Usuário:</strong> qualquer pessoa autorizada pelo Leiloeiro a acessar e utilizar o ERP, com
                  permissões designadas conforme seu papel (por exemplo: colaboradores da equipe do Leiloeiro,
                  comitentes, arrematantes).
                </li>
                <li>
                  <strong>ERP:</strong> o software de gestão empresarial oferecido pela Suporte Leilões na forma de
                  serviço (SaaS), englobando módulos para administração de leilões e atividades correlatas.
                </li>
                <li>
                  <strong>Marketplace:</strong> plataforma integrada ao ERP onde o Leiloeiro pode contratar produtos e
              ...
              <p>
                Para utilizar o ERP/SaaS da Suporte Leilões, é necessário ser um Leiloeiro
                ...
                junto aos órgãos competentes, conforme exigido por lei.
              </p>

              <h2>4. Licenciamento e Uso do Software</h2>
              <p>
                Cada licença de uso do software ERP é individual, intransferível e de uso exclusivo do Leiloeiro
                ...
                mais de uma jurisdição), desde que devidamente comprovadas.
              </p>
              <p>
                Qualquer utilização do ERP para
              ...
              <p>
                O Leiloeiro também tem direito a um website próprio fornecido como parte
              ...
              <p>
                O ERP da Suporte Leilões é composto por diversos
                ...
                módulos do sistema e observações sobre limites quando aplicável:
              </p>
              <ul>
              ...
              <p>
                A Suporte Leilões oferece diferentes planos de assinatura do ERP,
                adequados ao porte e às necessidades de cada Leiloeiro. Abaixo resumimos os recursos e limites de cada
                plano atualmente disponível:
              </p>

              <h3>Plano Simplificado</h3>
              <ul>
                <li>
                  <strong>Módulos incluídos:</strong> Gestão de Bens, Leilões, Comitentes, Arrematantes, Controle do
                  Website, Relatórios e Configurações.
                </li>
                <li>
                  <strong>Infraestrutura:</strong> Nível SL-1 (servidor compartilhado) – infraestrutura básica voltada
                  a pequenos leilões e leiloeiros iniciantes, com capacidade limitada.
                </li>
                <li>
                  <strong>Limite de cadastro de arrematantes:</strong> até 2.000 arrematantes cadastrados no sistema.
                </li>
                <li>
                  <strong>Espaço de armazenamento:</strong> 20 GB para arquivos (como editais, fotos de bens,
                  documentos de arrematantes).
                </li>
                <li>
                  <strong>Tráfego de dados:</strong> 20 GB de transferência de dados por mês.</li>
                <li>
                  <strong>Suporte técnico:</strong> atendimento exclusivamente via abertura de chamados no sistema
              ...
              <ul>
                <li>
                  <strong>Infraestrutura:</strong> Nível SL-2 (ambiente dedicado para clientes Premium)
                </li>
                <li>
                  <strong>Módulos incluídos:</strong> todos os módulos do ERP estão disponíveis sem restrições.</li>
                <li>
                  <strong>Espaço de armazenamento:</strong> 50 GB inclusos. Espaço adicional disponível a R$ 0,80 por
                  GB extra utilizado.
                </li>
                <li>
                  <strong>Tráfego de dados:</strong> ilimitado (sem cobranças por volume de transferência).</li>
                <li>
                  <strong>Aplicativo de Vistoria:</strong> acesso ao aplicativo móvel de Vistoria, que auxilia no
                  cadastro de bens e upload de fotos diretamente do local do bem.
                </li>
                <li>
                  <strong>Suporte técnico aprimorado:</strong> suporte disponibilizado via grupo dedicado no WhatsApp
                  para solução de dúvidas e também através de abertura de chamados para solicitações de
                  desenvolvimento/customização.
                </li>
                <li>
                  <strong>Marketplace:</strong> acesso total ao marketplace de serviços integrados, possibilitando a
              ...
              <ul>
                <li>
                  <strong>Infraestrutura:</strong> Nível SL-3 (ambiente de hospedagem exclusivo para clientes
                  Enterprise) – recursos de alto desempenho e máxima disponibilidade.
                </li>
                <li>
                  <strong>Módulos incluídos:</strong> todos os módulos do ERP estão disponíveis sem restrições.</li>
                <li>
                  <strong>Espaço de armazenamento:</strong> 1TB inclusos. Espaço adicional disponível a R$ 0,40 por
                  GB extra utilizado.
                </li>
                <li>
                  <strong>Tráfego de dados:</strong> ilimitado.</li>
                <li>
                  <strong>Aplicativo de Vistoria:</strong> incluído (mesmas facilidades do plano Premium).</li>
                <li>
                  <strong>Aplicativo de Reboquista + GPS:</strong> acesso ao aplicativo móvel para controladores de
                  pátio/reboque, com rastreamento via GPS, exclusivo do plano Enterprise.
                </li>
                <li>
                  <strong>Suporte e consultoria dedicados:</strong> além do grupo de WhatsApp, o cliente Enterprise
                  conta com suporte via ligação telefônica ou WhatsApp direta com o consultor exclusivo da equipe de consultoria, e
                  acompanhamento por chamados com gerenciamento de desenvolvimento conforme SLA acordado.
                </li>
                <li>
                  <strong>Marketplace:</strong> acesso total ao marketplace para contratação de serviços adicionais
                  sob demanda, similar ao plano Premium.
                </li>
                <li>
                  <strong>Consultoria especializada:</strong> orientação operacional e de marketing personalizada.
                </li>
                <li>
                  <strong>Equipe dedicada:</strong> alocação de desenvolvedor exclusivo para demandas do cliente, além
              ...
              <p>
                O Leiloeiro é responsável pela utilização do ERP tanto por si
                ...
                senhas de acesso e zelar pela integridade dos dados e das transações efetuadas no ERP.
              </p>
              <p>
                A Suporte
                ...
                rigorosas políticas internas de segurança da informação e a estar em conformidade com a{" "}
                <strong>Lei Geral de Proteção de Dados (LGPD)</strong>, de forma a proteger os dados armazenados em sua plataforma.
              </p>
              ...
              <p>
                <strong>🚫 Uso Proibido:</strong> Não é permitido utilizar a plataforma
                ...
                serviço e a rescisão do contrato, sem direito a reembolso.
              </p>
              <p>
                Dessa forma, o Leiloeiro e seus Usuários
                concordam em <strong>não praticar nenhuma das seguintes condutas</strong> ao utilizar a plataforma Suporte Leilões:
              </p>

              <ul>
                <li>
                  Violar quaisquer leis ou regulamentos aplicáveis (municipais, estaduais ou federais).</li>
                <li>
                  Promover ou incentivar atividades ilegais, ou discutir instruções sobre como praticá-las.</li>
                <li>
                  Infringir direitos de terceiros, incluindo direitos de privacidade, publicidade, direitos autorais,
                  marcas registradas, patentes, segredos comerciais ou outros direitos de propriedade intelectual.
                </li>
                <li>
                  Publicar ou transmitir conteúdo ofensivo, ameaçador, abusivo, calunioso, obsceno, discriminatório,
                  vulgar, ou qualquer material que promova violência, ódio ou atividades ilícitas.
                </li>
                <li>
                  Praticar qualquer ato que prejudique ou interfira na utilização do ERP por outros usuários,
                  incluindo ataques, tentativas de invasão ou sobrecarga intencional de recursos.
                </li>
                <li>
                  Tentar se passar por outra pessoa, organização ou entidade, falsificando ou omitindo informações (ou
                  fornecer informações falsas) com a intenção de enganar.
                </li>
                <li>
                  Utilizar a plataforma para fins de spam, esquemas de pirâmide, correntes, ou qualquer forma de
                  solicitação comercial não autorizada ou em desacordo com estes Termos.
                </li>
                <li>
                  Acessar ou usar contas de outros usuários sem a devida permissão.</li>
                <li>
                  Distribuir vírus, malware ou qualquer código malicioso que possa comprometer a integridade de
                  sistemas, equipamentos ou dados de terceiros.
                </li>
                <li>
                  Interferir, remover, evitar ou driblar medidas de segurança, mecanismos de proteção ou restrições de
                  acesso implementadas no sistema.
                </li>
                <li>
                  Realizar engenharia reversa, descompilar, desmontar ou tentar extrair o código-fonte do software,
                  exceto se expressamente permitido por lei ou autorizado por nós por escrito.
                </li>
                <li>
                  Capturar, explorar ou divulgar dados ou conteúdo de outros usuários de forma não autorizada, ou fora
                  das finalidades previstas na plataforma.
                </li>
                <li>
                  Usar os serviços da Suporte Leilões para comparar ou desenvolver um serviço ou produto concorrente,
                  sem autorização.
                </li>
                <li>
                  Qualquer outra ação não mencionada acima, mas que seja considerada imprópria, antiética ou em
                  desacordo com as políticas de uso da Suporte Leilões.
                </li>
              </ul>

              <p>
                Se você identificar qualquer uso indevido da plataforma ou conteúdo que viole estas diretrizes,
                comunique-nos imediatamente por meio do nosso{" "}
                <a
                  href="https://www.suporteleiloes.com.br/atendimento"
                  target="_blank"
                >
              ...
              <p>
                🔒 A utilização do ERP da Suporte Leilões implica também na
                aceitação de nossa{" "}
                <a
                  href="https://docs.suporteleiloes.com/politicas/privacidade/"
                  target="_blank"
                >
                  Política de Privacidade
                </a>.
                Nós coletamos, utilizamos, armazenamos e protegemos os dados pessoais e informações
                ...
                proteção de dados, entre em contato conosco pelo e-mail{" "}
                <a
                  href="mailto:juridico@suporteleiloes.com"
                >
                  juridico@suporteleiloes.com
                </a>.
              </p>

              <h2> 11. Restrições e Limitações de Responsabilidade</h2>
              <p>
                <strong>⚠️ Limitação de Responsabilidade:</strong> A Suporte
                Leilões não se responsabiliza, em nenhuma hipótese, por:
              </p>
              <ul>
              ...
              <p>
                Além das limitações acima, a responsabilidade total da Suporte Leilões, em qualquer hipótese, fica
              ...
              <p>
                O Leiloeiro (cliente) pode solicitar o cancelamento
                de sua conta e dos serviços contratados a qualquer momento, diretamente através do ERP ou por meio de
                solicitação enviada para o e-mail <a href="mailto:juridico@suporteleiloes.com">juridico@suporteleiloes.com</a>.
                É necessário observar um prazo mínimo de 30 (trinta) dias de antecedência para a efetivação do cancelamento
                sem cobrança da próxima recorrência.
              </p>
              <p>
                Após formalizar o pedido de cancelamento, a Suporte Leilões disponibilizará ao
              ...
              <p>
                A rescisão do contrato de prestação de serviços estará sujeita às
              ...
              <p>
                Para conhecer detalhadamente os níveis de
                serviço oferecidos (SLA – <em>Service Level Agreement</em>, ou Acordo de Nível de Serviço) e as políticas
                de suporte técnico da Suporte Leilões, por favor consulte o documento{" "}
                <a
                  href="https://docs.suporteleiloes.com/politicas/atendimento/"
                  target="_blank"
                >
                  Políticas de Atendimento
                </a> em nosso site. Nesse documento, estão descritos os horários de atendimento, canais de
                contato, tempos de resposta e outras informações relacionadas ao suporte ao cliente.
              </p>

              <h2>14. Considerações Finais</h2>
              <p>
                Em síntese, estes Termos de Uso têm o objetivo de estabelecer claramente as
                ...
                colaboração de todos no cumprimento fiel de todas as regras aqui descritas.
              </p>
              ...
              <p>
                ...
                aperfeiçoar seus produtos, serviços e políticas para melhor atendê-los.
              </p>
            </div>
          </div>
        </main>
